...
def get_options():
    ...
    parser.add_option(
        ...
        dest="sess_path",
        type="string",
        default="models/PerformanceRNN.sess",
    )
    ...
    parser.add_option(
        "-p", "--model-params", dest="model_params", type="string", default=""
    )
...
try:
    for iteration in range(100000):
        batch_gen = dataset.paired_batches(batch_size, window_size, stride_size)
        events, controls, image_batch, label_batch = batch_gen
